...
import universe from "@/app/assets/universe.png";

export default function Universe() {
  return (
    <div className="w-full h-auto top-[3810px]">
      <div className="w-full  px-20 max-w-[1440px] flex flex-col lg:flex-row gap-[30px] lg:px-0">
        {/* Image Section */}
        ...
        {/* Text Section */}
        <div className="w-full lg:w-[573px] h-auto flex flex-col gap-[20px] justify-center items-center px-20 lg:items-start text-center lg:text-left mt-[20px] lg:mt-0">
