...
export default function CardText() {
  return (
    <div className="w-[239px] h-[200px] py-[5px] px-[25px] flex flex-col items-center justify-center gap-[10px] border border-gray-200 rounded-lg shadow-sm sm:w-[280px] sm:h-[220px] md:w-[300px] md:h-[240px]">
