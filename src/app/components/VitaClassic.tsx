...
const VitaClassic = () => {
  return (
    <div className="relative w-full h-screen flex bg-[#23856D]">
      {/* Left Content */}
      <div className="absolute inset-0 flex flex-col justify-center items-start text-white space-y-4 max-w-md text-left transform -translate-x-1/2 -translate-y-1/2 left-1/3 top-1/2">
  ...
  <div className="flex items-center gap-4">
    ...
    <button className="bg-[#3AB666] text-white py-2 px-6 rounded-md font-semibold hover:bg-green-600">
      ...
      {/* Right Image */}
      <div className="absolute bottom-0 right-12 w-[60%] flex justify-center">
        <Image
